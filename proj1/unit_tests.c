...
bool test_is_tail() {
  ...
  bool tail1 = is_tail('w');
  assert(tail1);
  bool tail2 = is_tail('a');
  assert(tail2);
  bool tail3 = is_tail('s');
  assert(tail3);
  bool tail4 = is_tail('d');
  assert(tail4);
  bool tail5 = is_tail('b');
  assert(!tail5);
  printf("%s\n", "is_tail has passed all tests!");
...
bool test_is_snake() {
  // TODO: Implement this if you'd like!
  bool snake1 = is_snake('w');
  assert(snake1);
  bool snake2 = is_snake('a');
  assert(snake2);
  bool snake3 = is_snake('s');
  assert(snake3);
  bool snake4 = is_snake('d');
  assert(snake4);
  bool snake5 = is_snake('^');
  assert(snake5);
  bool snake6 = is_snake('<');
  assert(snake6);
  bool snake7 = is_snake('>');
  assert(snake7);
  bool snake8 = is_snake('v');
  assert(snake8);
  bool snake9 = is_snake('x');
  assert(snake9);
  bool non_snake = is_snake('e');
  assert(!non_snake);
  printf("%s\n", "is_snake has passed all tests!");
...
bool test_body_to_tail() {
  // TODO: Implement this if you'd like!
  char cvt1 = body_to_tail('^');
  assert(cvt1 == 'w');
  char cvt2 = body_to_tail('<');
  assert(cvt2 == 'a');
  char cvt3 = body_to_tail('>');
  assert(cvt3 == 'd');
  char cvt4 = body_to_tail('v');
  assert(cvt4 == 's');
  char cvt5 = body_to_tail('x');
  assert(cvt5 == ' ');
  printf("%s\n", "body_to_tail has passed all tests!");
